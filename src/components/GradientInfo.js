...
import Nachhaltigkeit from "../images/Nachhaltigkeit.png";
import Energieerzeugung from "../images/Energieerzeugung.png";
import Energieeffizienz from "../images/Energieeffizienz.png";
import Wartungskosten from "../images/Wartungskosten.png";
import Materialkosten from "../images/Materialkosten.png";
import Energiekosten from "../images/Energiekosten.png";
import WPBa from "../images/WPB.png";
const options = [
  {
    src: Nachhaltigkeit,
      ...
      <div className="options-bar">
        {options.map((option, index) => (
          <div
            ...
            style={{
              border: selectedOption === option ? "5px solid #2F6185" : "0px",
              borderRadius: "100%",
              padding: "15px",
              marginRight: "30px",
            }}
          >
            <img className="icon" src={option.src} alt={option.text} />
          </div>
        ))}
      </div>
